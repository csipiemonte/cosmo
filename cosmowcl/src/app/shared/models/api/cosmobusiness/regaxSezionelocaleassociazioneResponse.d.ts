...
/**
 * response per creazione sezionelocaleassociazione
 */
export interface RegaxSezionelocaleassociazioneResponse { 
    success?: boolean;
    version?: string;
    sezionelocaleassociazione?: RegaxSezionelocaleassociazione;
    statusCode?: number;
    error?: RegaxErrore;
}
