...
@ComponentScan(basePackages = {"it.csi.cosmo.cosmonotifications.business",
    "it.csi.cosmo.cosmonotifications.integration.mapper",
    "it.csi.cosmo.cosmonotifications.integration.rest"},
excludeFilters = {@Filter(type = FilterType.ANNOTATION, value = Configuration.class)})

@EnableJpaRepositories(basePackages = {"it.csi.cosmo.cosmonotifications.integration.repository"},
repositoryFactoryBeanClass = CosmoRepositoryFactory.class)
@EnableTransactionManagement

@TestExecutionListeners({DirtiesContextTestExecutionListener.class})
public class CwnotificationsUnitTestInMemory {
