...
@ComponentScan(basePackages = {"it.csi.cosmo.cosmonotification.business",
    "it.csi.cosmo.cosmonotification.integration.mapper",
    "it.csi.cosmo.cosmonotification.integration.rest"},
...
public class CwnotificationsUnitTestDB {
