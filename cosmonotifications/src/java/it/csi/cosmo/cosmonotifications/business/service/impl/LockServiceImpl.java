...
import it.csi.cosmo.cosmonotifications.dto.LockPolicyConfiguration;
import it.csi.cosmo.cosmonotifications.integration.repository.CosmoTLockRepository;
import it.csi.cosmo.cosmonotifications.integration.repository.CosmoTUtenteRepository;
...
public class LockServiceImpl implements LockService {
  ...
  private CosmoLogger logger =
      LoggerFactory.getLogger(LogCategory.COSMONOTIFICATIONS_BUSINESS_LOG_CATEGORY, this.getClass().getSimpleName());
