...
import it.csi.cosmo.cosmonotifications.integration.repository.CsiLogAuditRepository;
...
public class AuditServiceImpl implements AuditService {
  ...
  private static final CosmoLogger logger =
      LoggerFactory.getLogger(LogCategory.COSMONOTIFICATIONS_AUDIT_LOG_CATEGORY,
          "AuditServiceImpl");
