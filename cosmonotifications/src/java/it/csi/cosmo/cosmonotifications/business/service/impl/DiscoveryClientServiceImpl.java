...
import it.csi.cosmo.cosmonotifications.business.service.DiscoveryClientService;
...
implements DiscoveryClientService, InitializingBean, DisposableBean {
  ...
  public void afterPropertiesSet() throws Exception {
    AsyncUtils.when("INIT_DISCOVERY_SERVICE", LoggerConstants.COSMONOTIFICATIONS_ROOT_LOG_CATEGORY,
