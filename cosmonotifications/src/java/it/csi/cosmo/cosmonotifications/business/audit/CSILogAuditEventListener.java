...
package it.csi.cosmo.cosmonotifications.business.audit;

import javax.persistence.PrePersist;
import javax.persistence.PreRemove;
import javax.persistence.PreUpdate;
import it.csi.cosmo.common.logger.CosmoLogger;
import it.csi.cosmo.cosmonotifications.business.service.AuditService;
import it.csi.cosmo.cosmonotifications.business.service.impl.AuditServiceImpl;
...
public class CSILogAuditEventListener {
  ...
  private static final CosmoLogger logger = LoggerFactory
      .getLogger(LogCategory.COSMONOTIFICATIONS_BUSINESS_LOG_CATEGORY, "CSILogAuditEventListener");
