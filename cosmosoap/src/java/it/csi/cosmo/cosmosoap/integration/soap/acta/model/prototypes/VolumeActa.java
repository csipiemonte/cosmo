 ...
 *
 */
public abstract class VolumeActa extends AggregazioneActa {

  @ActaProperty(propertyName = "intervalloNumericoA")
  protected String intervalloNumericoA;

  @ActaProperty(propertyName = "intervalloNumericoDa")
  ...
  public void seIntervalloNumericoA(String intervalloNumericoA) {
  ...
  public void setIntervalloNumericoDa(String intervalloNumericoDa) {
