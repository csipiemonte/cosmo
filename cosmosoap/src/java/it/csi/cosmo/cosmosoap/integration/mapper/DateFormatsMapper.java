...
public interface DateFormatsMapper {
  ...
  default OffsetDateTime mapOffsetDateTime(XMLGregorianCalendar value) {
    return value == null ? null
        : value.toGregorianCalendar().toZonedDateTime().toOffsetDateTime();
  }
  ...
  default java.time.OffsetDateTime map(java.time.ZonedDateTime value) {
    return value == null ? null
        : value.withZoneSameInstant(ZoneId.systemDefault()).toOffsetDateTime();
  }
}
