 ...
 *
 */
public class SerieFascicoliActaDefaultImpl extends SerieFascicoliActa {

  public SerieFascicoliActaDefaultImpl() {
    // NOP
  }

  @Generated("SparkTools")
  private SerieFascicoliActaDefaultImpl(Builder builder) {
    id = builder.id;
    dbKey = builder.dbKey;
  ...
  /**
   * Creates builder to build {@link SerieFascicoliActaDefaultImpl}.
   *
  ...
  /**
   * Builder to build {@link SerieFascicoliActaDefaultImpl}.
   */
  @Generated("SparkTools")
  public static final class Builder {
    ...
    public SerieFascicoliActaDefaultImpl build() {
      return new SerieFascicoliActaDefaultImpl(this);
    }
  }
