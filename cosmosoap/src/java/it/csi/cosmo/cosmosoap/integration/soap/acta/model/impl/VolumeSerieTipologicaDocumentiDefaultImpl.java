 ...
 *
 */
public class VolumeSerieTipologicaDocumentiDefaultImpl extends VolumeSerieTipologicaDocumenti {

  public VolumeSerieTipologicaDocumentiDefaultImpl() {
    // NOP
  }

  @Generated("SparkTools")
  private VolumeSerieTipologicaDocumentiDefaultImpl(Builder builder) {
    id = builder.id;
    dbKey = builder.dbKey;
  ...
  public String toString() {
    return "VolumeSerieFascicoliActaDefaultImpl [wrapping = " + super.toString() + "]";
  }

  /**
   * Creates builder to build {@link VolumeSerieTipologicaDocumentiDefaultImpl}.
   *
  ...
  /**
   * Builder to build {@link VolumeSerieTipologicaDocumentiDefaultImpl}.
   */
  @Generated("SparkTools")
  public static final class Builder {
    ...
    public VolumeSerieTipologicaDocumentiDefaultImpl build() {
      return new VolumeSerieTipologicaDocumentiDefaultImpl(this);
    }
  }
