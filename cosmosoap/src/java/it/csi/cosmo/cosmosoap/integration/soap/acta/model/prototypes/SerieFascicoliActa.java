 ...
 *
 */
@ActaModel(className = "SerieFascicoliPropertiesType")
public abstract class SerieFascicoliActa extends AggregazioneActa {

  public static SerieFascicoliActaDefaultImpl.Builder builder() {
    return SerieFascicoliActaDefaultImpl.builder();
  }
