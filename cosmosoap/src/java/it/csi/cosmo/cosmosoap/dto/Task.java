...
package it.csi.cosmo.cosmosoap.dto;
...
public class Task implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    Task task = (Task) o;
    return Objects.equals(id, task.id) && Objects.equals(action, task.action)
        && Objects.equals(assignee, task.assignee) && Objects.equals(createTime, task.createTime)
        ...
        && Objects.equals(execution, task.execution) && Objects.equals(name, task.name)
        && Objects.equals(category, task.category) && Objects.equals(owner, task.owner)
        ...
        && Objects.equals(url, task.url) && Objects.equals(tenantId, task.tenantId)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, action, assignee, createTime, delegationState, description, dueDate,
        execution, name, category, owner, parentTaskId, priority, processDefinition,
        processInstance, suspended, taskDefinitionKey, url, tenantId, formKey, processInstanceId,
        variables, cancellationDate, subtasks);
  }
