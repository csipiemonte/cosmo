...
/**
 * <p>Classe Java per DosignCertificateChainNotFoundException complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="DosignCertificateChainNotFoundException">
 *   &lt;complexContent>
...
@XmlType(name = "DosignCertificateChainNotFoundException", propOrder = {
    "nestedExcClassName",
    "stackTraceMessage",
    "nestedExcMsg",
    "message"
})
public class DosignCertificateChainNotFoundException {
