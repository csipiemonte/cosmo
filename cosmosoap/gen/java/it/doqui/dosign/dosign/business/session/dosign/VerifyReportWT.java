...
/**
 * <p>Classe Java per verifyReportWT complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="verifyReportWT">
 *   &lt;complexContent>
 *     &lt;extension base="{http://dosign.session.business.dosign.dosign.doqui.it/}dosignDto">
 *       &lt;sequence>
 *         &lt;element name="child" type="{http://dosign.session.business.dosign.dosign.doqui.it/}verifyReportWT" minOccurs="0"/>
 ...
 *         &lt;element name="signature" type="{http://dosign.session.business.dosign.dosign.doqui.it/}signatureWT" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "verifyReportWT", propOrder = {
    "child",
...
public class VerifyReportWT
    extends DosignDto
{

    protected VerifyReportWT child;
    ...
    protected List<SignatureWT> signature;
     ...
     *     
     */
    public VerifyReportWT getChild() {
        return child;
    }
     ...
     *     
     */
    public void setChild(VerifyReportWT value) {
        this.child = value;
    }
     ...
     * 
     */
    public List<SignatureWT> getSignature() {
        if (signature == null) {
            signature = new ArrayList<SignatureWT>();
        }
