...
/**
 * Rappresenta un soggetto interno all'AOO che può
 * 				essere: una UO, un utente, una scrivania virtuale (che rappresenta
 * 				l'utente non come persona, ma nella funzione che svolge presso una
 * 				certa UO), un gruppo (di utenti o UO o scrivanie virtuali) o un
 * 				ruolo amministrativo (es: Dirigente, Direttore Generale ecc). Quando
 * 				si assegna ad un gruppo o un ruolo il sistema assegna a tutti gli
 * 				utenti, UO e scrivanie del gruppo o aventi il ruolo
 * 			
 * 
