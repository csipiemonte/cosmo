...
@ComponentScan(
    basePackages = {"it.csi.cosmo.cosmosoap.business", "it.csi.cosmo.cosmosoap.integration.mapper",
        "it.csi.cosmo.cosmosoap.integration.rest", "it.csi.test.cosmo.cosmosoap.testbed.service"},
    excludeFilters = {@Filter(type = FilterType.ANNOTATION, value = Configuration.class)})

@EnableJpaRepositories(
    basePackages = {"it.csi.cosmo.cosmosoap.integration.repository",
        "it.csi.test.cosmo.cosmosoap.testbed.repository"},
repositoryFactoryBeanClass = CosmoRepositoryFactory.class)
@EnableTransactionManagement

@TestExecutionListeners({DirtiesContextTestExecutionListener.class})
public class CosmoSoapUnitTestDB {
