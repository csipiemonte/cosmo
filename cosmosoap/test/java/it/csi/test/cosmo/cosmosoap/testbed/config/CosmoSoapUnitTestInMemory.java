...
@ComponentScan(
    basePackages = {"it.csi.cosmo.cosmosoap.business", "it.csi.cosmo.cosmosoap.integration.mapper",
        "it.csi.cosmo.cosmosoap.integration.rest"},
    excludeFilters = {@Filter(type = FilterType.ANNOTATION, value = Configuration.class)})

@EnableJpaRepositories(basePackages = {"it.csi.cosmo.cosmosoap.integration.repository"},
repositoryFactoryBeanClass = CosmoRepositoryFactory.class)
@EnableTransactionManagement

@TestExecutionListeners({DirtiesContextTestExecutionListener.class})
public class CosmoSoapUnitTestInMemory {
