...
public class TagsResponse  implements Serializable {
  ...
  private List<Tag> elementi = new ArrayList<>();
  ...
  public List<Tag> getElementi() {
    return elementi;
  }
  public void setElementi(List<Tag> elementi) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(elementi, tagsResponse.elementi) &&
        Objects.equals(pageInfo, tagsResponse.pageInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(elementi, pageInfo);
  }
