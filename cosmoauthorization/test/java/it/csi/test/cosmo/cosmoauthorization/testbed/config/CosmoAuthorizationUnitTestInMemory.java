...
import it.csi.cosmo.common.cripto.StaticCredentialsConfigurationProvider;
...
public class CosmoAuthorizationUnitTestInMemory {
  ...
  public CryptoConverter cryptoConverter() {
    return CryptoConverter.builder()
        ...
        .withConfigurationProvider(StaticCredentialsConfigurationProvider.builder()
            .withLoggingPrefix(LogCategory.BUSINESS_LOG_CATEGORY.getCategory())
             .withIvParameter("MTIzNDEyMzQxMjM0MTIzNA==")
             .withPassPhrase("MTIzNDEyMzQxMjM0MTIzNA==")
            .build()
        )
        .build();
  }
  ...
  Properties additionalProperties () {
    ...
    properties.setProperty("hibernate.jdbc.lob.non_contextual_creation", Boolean.TRUE.toString());
    properties.setProperty("hibernate.show_sql", Boolean.FALSE.toString());
    properties.setProperty("hibernate.format_sql", Boolean.FALSE.toString());
