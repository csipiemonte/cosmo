...
public class MailServiceImpl implements MailService, DisposableBean {
  ...
  private static final CosmoLogger logger = LoggerFactory.getLogger(LogCategory.MAIL_LOG_CATEGORY, "MailServiceImpl");
  ...
  public Future<CosmoMailDeliveryResult> inviaMailAssistenza(String subject, String text) {
    ...
    subject = "[" + Constants.COMPONENT_DESCRIPTION + " " + (ConfigurazioneServiceImpl.getCurrentEnvironment())
        + "] " + subject;
  ...
  @Override
  public Future<CosmoMailDeliveryResult> inviaMailUtentiBatch(String to, String subject, String text) {
    String method = "inviaMailUtentiBatch";
    logger.debug(method, "invio della mail " + subject);
