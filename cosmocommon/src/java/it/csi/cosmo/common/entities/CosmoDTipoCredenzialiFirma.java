...
/**
 * The persistent class for the cosmo_d_tipo_credenziali_firma database table.
 *
 */
@Entity
@Table(name = "cosmo_d_tipo_credenziali_firma")
@NamedQuery(name = "CosmoDTipoCredenzialiFirma.findAll", query = "SELECT c FROM CosmoDTipoCredenzialiFirma c")
public class CosmoDTipoCredenzialiFirma extends CosmoDEntity {
  ...
  @OneToMany(mappedBy = "cosmoDTipoCredenzialiFirma")
  ...
  public CosmoDTipoCredenzialiFirma() {
    // empty constructor
  }
  ...
  public CosmoTCertificatoFirma addCosmoTCertificatoFirma(
    ...
    cosmoTCertificatoFirma.setCosmoDTipoCredenzialiFirma(this);
  ...
  public CosmoTCertificatoFirma removeCosmoTCertificatoFirma(
    ...
    cosmoTCertificatoFirma.setCosmoDTipoCredenzialiFirma(null);
  ...
  public CosmoDTipoPratica addCosmoDTipoPratica(CosmoDTipoPratica cosmoDTipoPratica) {
    ...
    cosmoDTipoPratica.setCosmoDTipoCredenzialiFirma(this);
  ...
  public CosmoDTipoPratica removeCosmoDTipoPratica(CosmoDTipoPratica cosmoDTipoPratica) {
    ...
    cosmoDTipoPratica.setCosmoDTipoCredenzialiFirma(null);
  ...
  public boolean equals(Object obj) {
    ...
    CosmoDTipoCredenzialiFirma other = (CosmoDTipoCredenzialiFirma) obj;
    if (codice == null) {
  ...
  public String toString() {
    return "CosmoDTipoCredenzialiFirma [" + (codice != null ? "codice=" + codice + ", " : "")
