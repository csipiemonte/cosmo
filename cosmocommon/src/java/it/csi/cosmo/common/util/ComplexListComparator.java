...
public interface ComplexListComparator {

  public static <T1, T2> DifferentListsDifference<T1, T2> compareSets(Set<T1> list1, Set<T2> list2,
      BiPredicate<T1, T2> matcher) {
    return compareLists(new LinkedList<>(list1), new LinkedList<>(list2), matcher);
  }

  public static <T1, T2> DifferentListsDifference<T1, T2> compareLists(List<T1> list1, // NOSONAR
      List<T2> list2, BiPredicate<T1, T2> matcher) {
  ...
  public static class DifferentListsDifference<T1, T2> {
    ...
    public DifferentListsDifference<T1, T2> onElementsInFirstNotInSecondWBC(Consumer<T1> consumer,
    ...
    public DifferentListsDifference<T1, T2> onElementsInSecondNotInFirstWBC(Consumer<T2> consumer,
        Supplier<Boolean> breakCondition) {
    ...
    public DifferentListsDifference<T1, T2> onElementsInBothFromFirstWBC(Consumer<T1> consumer,
        Supplier<Boolean> breakCondition) {
    ...
    public DifferentListsDifference<T1, T2> onElementsInBothFromSecondWBC(Consumer<T2> consumer,
        Supplier<Boolean> breakCondition) {
    ...
    public DifferentListsDifference<T1, T2> onElementsInBothWBC(BiConsumer<T1, T2> consumer,
        Supplier<Boolean> breakCondition) {
    ...
    public DifferentListsDifference<T1, T2> onElementsInBoth(BiConsumer<T1, T2> consumer,
        BiPredicate<T1, T2> breakCondition) {
