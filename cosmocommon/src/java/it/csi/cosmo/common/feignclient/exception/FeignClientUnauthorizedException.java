 ...
 *
 */
public class FeignClientUnauthorizedException extends FeignClientClientErrorException {
   ...
   * @param statusCode
   */
  public FeignClientUnauthorizedException(FeignClientRequestContext requestContext,
