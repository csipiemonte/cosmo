 ...
 *
 */
public class FeignClientUnprocessableEntityException extends FeignClientClientErrorException {
   ...
   * @param statusCode
   */
  public FeignClientUnprocessableEntityException(FeignClientRequestContext requestContext,
