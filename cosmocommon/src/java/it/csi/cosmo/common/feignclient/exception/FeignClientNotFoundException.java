 ...
 *
 */
public class FeignClientNotFoundException extends FeignClientClientErrorException {
   ...
   * @param statusCode
   */
  public FeignClientNotFoundException(FeignClientRequestContext requestContext,
