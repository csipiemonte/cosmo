 ...
 *
 */
public class FeignClientConflictException extends FeignClientClientErrorException {
   ...
   * @param statusCode
   */
  public FeignClientConflictException(FeignClientRequestContext requestContext,
