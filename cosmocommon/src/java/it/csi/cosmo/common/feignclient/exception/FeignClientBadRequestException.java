 ...
 *
 */
public class FeignClientBadRequestException extends FeignClientClientErrorException {
   ...
   * @param statusCode
   */
  public FeignClientBadRequestException(FeignClientRequestContext requestContext,
