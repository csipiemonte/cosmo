...
public class CustomFormResponse  implements Serializable {
  ...
  // nome originario nello yaml: customForms 
  ...
  public boolean equals(Object o) {
    ...
    CustomFormResponse customFormResponse = (CustomFormResponse) o;
    return Objects.equals(customForms, customFormResponse.customForms) &&
        Objects.equals(pageInfo, customFormResponse.pageInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customForms, pageInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomFormResponse {\n");
