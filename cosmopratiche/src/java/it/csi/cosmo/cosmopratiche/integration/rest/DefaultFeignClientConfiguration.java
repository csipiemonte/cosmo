...
public class DefaultFeignClientConfiguration implements FeignClientContextConfigurator {
  ...
  public void configure(FeignClientContext context) {
    ...
    context.setRestTemplate(RestTemplateUtils.builder().withAllowConnectionReuse(false)
        .withConnectionRequestTimeout(10000).withConnectTimeout(10000).withReadTimeout(30000)
        .build());
  }
}
