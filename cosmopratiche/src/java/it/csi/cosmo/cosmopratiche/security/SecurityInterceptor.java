...
import it.csi.cosmo.cosmopratiche.business.rest.impl.ParentApiImpl;
import it.csi.cosmo.cosmopratiche.business.service.ConfigurazioneService;
import it.csi.cosmo.cosmopratiche.business.service.impl.ConfigurazioneServiceImpl;
...
public class SecurityInterceptor implements ContainerRequestFilter {
  ...
  private static final CosmoLogger LOGGER =
      LoggerFactory.getLogger(LogCategory.COSMOPRATICHE_SECURITY_LOG_CATEGORY,
          "SecurityInterceptor");
  ...
  private void processAnnotationScopesRequirements(Secured annotation) {
    ...
    if (annotation.authenticatedClient()
        && !Boolean.FALSE.equals(client.getAnonimo())) {
      handleFailure(POLICY_PREFIX + "AUTHENTICATED");
    }
