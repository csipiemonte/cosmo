...
public class UserServiceImpl implements UserService {
  ...
  private CosmoLogger logger =
      LoggerFactory.getLogger(LogCategory.COSMOPRATICHE_BUSINESS_LOG_CATEGORY, "UserServiceImpl");
  ...
  public synchronized UserInfoDTO getUtenteCorrente() {
    ...
    UserInfoDTO output = (UserInfoDTO) req.getAttribute(USERINFO_REQUESTATTR);
