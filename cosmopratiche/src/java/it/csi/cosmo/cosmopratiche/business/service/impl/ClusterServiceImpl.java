...
public class ClusterServiceImpl implements ClusterService, InitializingBean {
  ...
  private static final String MASTER_INSTANCE_RESOURCE_CODE = "PRATICHE_MASTER_INSTANCE_LEASE";

  private static final int MASTER_INSTANCE_LEASE_INTERVAL = 5 * 1000;

  private CosmoLogger logger =
      LoggerFactory.getLogger(LogCategory.COSMOPRATICHE_BUSINESS_LOG_CATEGORY,
  ...
  private InfinispanFingerprintHelper fingerprintHelper =
      new InfinispanFingerprintHelper(LoggerConstants.COSMOPRATICHE_ROOT_LOG_CATEGORY);

  @Override
  public void afterPropertiesSet() throws Exception {
    AsyncUtils.when("INIT_CLUSTER_SERVICE", LoggerConstants.COSMOPRATICHE_ROOT_LOG_CATEGORY,
  ...
  private void initNegotiator() {
    ...
    lockManager =
        new InfinispanLockManager(connector.getCache(),
            LoggerConstants.COSMOPRATICHE_ROOT_LOG_CATEGORY);
