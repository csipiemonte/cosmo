...
import it.csi.cosmo.cosmopratiche.dto.LockPolicyConfiguration;
import it.csi.cosmo.cosmopratiche.integration.repository.CosmoTLockRepository;
...
public class LockServiceImpl implements LockService {
  ...
  private CosmoLogger logger =
      LoggerFactory.getLogger(LogCategory.COSMOPRATICHE_BUSINESS_LOG_CATEGORY, this.getClass().getSimpleName());
