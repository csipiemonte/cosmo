...
import it.csi.cosmo.cosmopratiche.integration.repository.CsiLogAuditRepository;
...
public class AuditServiceImpl implements AuditService {
  ...
  private static final CosmoLogger logger =
      LoggerFactory.getLogger(LogCategory.COSMOPRATICHE_AUDIT_LOG_CATEGORY, "AuditServiceImpl");
  ...
  private String getPrincipalCode() {
