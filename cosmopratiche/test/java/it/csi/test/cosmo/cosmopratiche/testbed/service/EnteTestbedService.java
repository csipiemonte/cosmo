...
import it.csi.test.cosmo.cosmopratiche.testbed.repository.CosmoTEnteTestbedRepository;
...
public class EnteTestbedService {
  ...
  @Transactional
  public CosmoTEnte getEnte(String codiceIpa) {

    return cosmoTEnteTestbedRepository.findOneNotDeletedByField(CosmoTEnte_.codiceIpa, codiceIpa)
        .orElseGet(null);
  }
