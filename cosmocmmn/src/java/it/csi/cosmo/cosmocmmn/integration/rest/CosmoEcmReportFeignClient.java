...
import it.csi.cosmo.cosmoecm.client.ReportApi;
...
@FeignClient(value = "${" + ParametriApplicativo.DISCOVERY_SERVER_LOCATION_KEY
    + "}/api/proxy/ecm/report", configurator = CosmoCmmnFeignClientConfiguration.class,
    interceptors = CosmoCmmnFeignClientAuthenticator.class)
public interface CosmoEcmReportFeignClient extends ReportApi {
