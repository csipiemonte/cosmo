...
import it.csi.cosmo.cosmopratiche.client.MetadatiApi;
...
@FeignClient(value = "${" + ParametriApplicativo.DISCOVERY_SERVER_LOCATION_KEY
    + "}/api/proxy/pratiche/metadati", configurator = CosmoCmmnFeignClientConfiguration.class,
    interceptors = CosmoCmmnFeignClientAuthenticator.class)
public interface CosmoPraticheMetadatiFeignClient extends MetadatiApi {
