...
import it.csi.cosmo.cosmosoap.client.StiloApi;
...
@FeignClient(value = "${" + ParametriApplicativo.DISCOVERY_SERVER_LOCATION_KEY
    + "}/api/proxy/soap/stilo", configurator = CosmoCmmnFeignClientConfiguration.class,
    interceptors = CosmoCmmnFeignClientAuthenticator.class)
public interface CosmoSoapStiloFeignClient extends StiloApi {
