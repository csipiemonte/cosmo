...
public class MailServiceImpl implements MailService, DisposableBean {
  ...
  @Override
  public Future<CosmoMailDeliveryResult> inviaMail(List<String> to, String from, String fromName,
    ...
    if (StringUtils.isBlank(from)) {
      from = configurazioneService.requireConfig(ParametriApplicativo.MAIL_DEFAULT_FROM).asString();
    }

    if (StringUtils.isBlank(fromName)) {
      fromName = configurazioneService.requireConfig(ParametriApplicativo.MAIL_DEFAULT_FROM_NAME)
          .asString();
    }
