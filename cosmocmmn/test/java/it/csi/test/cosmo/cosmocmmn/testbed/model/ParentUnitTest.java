...
package it.csi.test.cosmo.cosmocmmn.testbed.model;
...
import it.csi.cosmo.cosmocmmn.util.listener.AppServletContextListener;
  ...
  protected <T> T getBean ( Class<T> beanClass ) {
    ...
    if ( AopUtils.isAopProxy ( rawBean ) && rawBean instanceof Advised ) {
      ...
      try {
        ...
        throw new InternalServerException("Error getting bean", e);
      }
    }
