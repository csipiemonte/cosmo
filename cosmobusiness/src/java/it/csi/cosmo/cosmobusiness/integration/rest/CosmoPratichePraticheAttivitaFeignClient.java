...
import it.csi.cosmo.cosmopratiche.client.PraticheAttivitaApi;
...
@FeignClient(
    ...
    + "}/api/proxy/pratiche/pratiche-attivita",
    interceptors = CosmoBusinessFeignClientConfiguration.class,
    configurator = DefaultFeignClientConfiguration.class)
public interface CosmoPratichePraticheAttivitaFeignClient extends PraticheAttivitaApi {
}
