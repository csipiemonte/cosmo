...
import it.csi.cosmo.cosmobusiness.integration.repository.CsiLogAuditRepository;
...
public class AuditServiceImpl implements AuditService {
  ...
  public void prePersist(Object target) {
    ...
    if (logger.isTraceEnabled()) {
      logger.trace("prePersist", "PERSISTING - {}", ObjectUtils.represent(target));
    }
  ...
  public void preUpdate(Object target) {
    ...
    if (logger.isTraceEnabled()) {
      logger.trace("preUpdate", "UPDATING - {}", ObjectUtils.represent(target));
    }
  ...
  public void preRemove(Object target) {
    ...
    if (logger.isTraceEnabled()) {
      logger.trace("preRemove", "REMOVING - {}", ObjectUtils.represent(target));
    }
  ...
  private void save(CsiLogAudit raw) {
    if (logger.isTraceEnabled()) {
      logger.trace("save", "[AUDIT] saving audit entity " + ObjectUtils.represent(raw));
    }
