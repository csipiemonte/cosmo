...
@Path("/regax") @Consumes({ "application/json" }) @Produces({ "application/json" })
public interface RegaxApi  {
   
    @DELETE @Path("/api/delete/Allegati/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxAllegatiDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Allegati/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxAllegatiResponse regaxAllegatiGet( @PathParam("key") String key);

    @GET @Path("/api/list/Allegati") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Allegatiass/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxAllegatiassDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Allegatiass/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxAllegatiassResponse regaxAllegatiassGet( @PathParam("key") String key);

    @GET @Path("/api/list/Allegatiass") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Associazione/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxAssociazioneDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Associazione/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxAssociazioneResponse regaxAssociazioneGet( @PathParam("key") String key);

    @GET @Path("/api/list/Associazione") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Comunicazioni/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxComunicazioniDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Comunicazioni/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxComunicazioniResponse regaxComunicazioniGet( @PathParam("key") String key);

    @GET @Path("/api/list/Comunicazioni") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Contestodelibera/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxContestodeliberaDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Contestodelibera/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxContestodeliberaResponse regaxContestodeliberaGet( @PathParam("key") String key);

    @GET @Path("/api/list/Contestodelibera") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Deliberaass/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxDeliberaassDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Deliberaass/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxDeliberaassResponse regaxDeliberaassGet( @PathParam("key") String key);

    @GET @Path("/api/list/Deliberaass") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Delibere/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxDelibereDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Delibere/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxDelibereResponse regaxDelibereGet( @PathParam("key") String key);

    @GET @Path("/api/list/Delibere") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Livelloassociazione/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxLivelloassociazioneDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Livelloassociazione/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxLivelloassociazioneResponse regaxLivelloassociazioneGet( @PathParam("key") String key);

    @GET @Path("/api/list/Livelloassociazione") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Naturagiuridica/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxNaturagiuridicaDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Naturagiuridica/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxNaturagiuridicaResponse regaxNaturagiuridicaGet( @PathParam("key") String key);

    @GET @Path("/api/list/Naturagiuridica") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Persone/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxPersoneDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Persone/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxPersoneResponse regaxPersoneGet( @PathParam("key") String key);

    @GET @Path("/api/list/Persone") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Personeass/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxPersoneassDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Personeass/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxPersoneassResponse regaxPersoneassGet( @PathParam("key") String key);

    @GET @Path("/api/list/Personeass") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Protocollo/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxProtocolloDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Protocollo/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxProtocolloResponse regaxProtocolloGet( @PathParam("key") String key);

    @GET @Path("/api/list/Protocollo") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Relazioneass/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxRelazioneassDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Relazioneass/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxRelazioneassResponse regaxRelazioneassGet( @PathParam("key") String key);

    @GET @Path("/api/list/Relazioneass") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Relazioni/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxRelazioniDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Relazioni/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxRelazioniResponse regaxRelazioniGet( @PathParam("key") String key);

    @GET @Path("/api/list/Relazioni") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Sedelegaleassociazione/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxSedelegaleassociazioneDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Sedelegaleassociazione/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxSedelegaleassociazioneResponse regaxSedelegaleassociazioneGet( @PathParam("key") String key);

    @GET @Path("/api/list/Sedelegaleassociazione") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Sedeoperativa/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxSedeoperativaDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Sedeoperativa/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxSedeoperativaResponse regaxSedeoperativaGet( @PathParam("key") String key);

    @GET @Path("/api/list/Sedeoperativa") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Sedime/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxSedimeDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Sedime/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxSedimeResponse regaxSedimeGet( @PathParam("key") String key);

    @GET @Path("/api/list/Sedime") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Settint/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxSettintDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Settint/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxSettintResponse regaxSettintGet( @PathParam("key") String key);

    @GET @Path("/api/list/Settint") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Settoreinterventoass/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxSettoreinterventoassDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Settoreinterventoass/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxSettoreinterventoassResponse regaxSettoreinterventoassGet( @PathParam("key") String key);

    @GET @Path("/api/list/Settoreinterventoass") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Sezionelocaleassociazione/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxSezionelocaleassociazioneDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Sezionelocaleassociazione/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxSezionelocaleassociazioneResponse regaxSezionelocaleassociazioneGet( @PathParam("key") String key);

    @GET @Path("/api/list/Sezionelocaleassociazione") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Statoassociazione/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxStatoassociazioneDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Statoassociazione/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxStatoassociazioneResponse regaxStatoassociazioneGet( @PathParam("key") String key);

    @GET @Path("/api/list/Statoassociazione") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Tiporuolo/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxTiporuoloDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Tiporuolo/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxTiporuoloResponse regaxTiporuoloGet( @PathParam("key") String key);

    @GET @Path("/api/list/Tiporuolo") @Consumes({ "application/json" }) @Produces({ "application/json" })
    ...
    @DELETE @Path("/api/delete/Uffici/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxEmptyResponse regaxUfficiDelete( @PathParam("key") String key);

    @GET @Path("/api/view/Uffici/{key}") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RegaxUfficiResponse regaxUfficiGet( @PathParam("key") String key);

    @GET @Path("/api/list/Uffici") @Consumes({ "application/json" }) @Produces({ "application/json" })
