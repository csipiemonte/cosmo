...
public interface FeaApi  {
    ...
    @POST @Path("/firma") @Consumes({ "application/json" }) @Produces({ "application/json" })
    public RiferimentoOperazioneAsincrona postFeaFirma( @Valid FirmaFeaRequest body);

    @POST @Path("/richiedi-otp")  
    public void postFeaRichiediOtp();
