...
public class RichiediSmistamentoRequest  implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    RichiediSmistamentoRequest richiediSmistamentoRequest = (RichiediSmistamentoRequest) o;
    return Objects.equals(identificativoMessaggio, richiediSmistamentoRequest.identificativoMessaggio) &&
        Objects.equals(tipiDocumento, richiediSmistamentoRequest.tipiDocumento);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identificativoMessaggio, tipiDocumento);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RichiediSmistamentoRequest {\n");
