...
@ComponentScan(
    basePackages = {"it.csi.cosmo.cosmoecm.business", "it.csi.cosmo.cosmoecm.integration.mapper",
        "it.csi.cosmo.cosmoecm.integration.rest",
        "it.csi.test.cosmo.cosmoecm.testbed.service"},
    excludeFilters = {@Filter(type = FilterType.ANNOTATION, value = Configuration.class)})

@EnableJpaRepositories(basePackages = {"it.csi.cosmo.cosmoecm.integration.repository",
    "it.csi.test.cosmo.cosmoecm.testbed.repository"},
repositoryFactoryBeanClass = CosmoRepositoryFactory.class)
@EnableTransactionManagement

@TestExecutionListeners({DirtiesContextTestExecutionListener.class})
public class CosmoEcmUnitTestInMemory {
