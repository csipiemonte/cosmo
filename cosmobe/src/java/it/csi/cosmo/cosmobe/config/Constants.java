...
public class Constants {
  ...
  public static final String BE_ORCHESTRATOR_USERNAME = "COSMO_BE_ORCHESTRATOR";
   ...
   */
  public static final String COMPONENT_NAME = "cosmobe";

  public static final String COMPONENT_DESCRIPTION = "Cosmo BE";
  ...
  public static class DISCOVERY {
    ...
    public static final String SERVICE_ROUTE = "be";
