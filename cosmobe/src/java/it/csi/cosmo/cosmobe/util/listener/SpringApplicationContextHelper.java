...
package it.csi.cosmo.cosmobe.util.listener;
...
import it.csi.cosmo.cosmobe.business.rest.impl.ParentApiImpl;
...
public class SpringApplicationContextHelper implements ApplicationContextAware {
  ...
  public static <T extends ParentApiImpl> T getImplementationResource(
    ...
    try {
      ...
      throw new BadConfigurationException("Could not instantiate resource implementation for class "
