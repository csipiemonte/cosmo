...
import it.csi.cosmo.cosmobe.business.service.DiscoveryClientService;
...
implements DiscoveryClientService, InitializingBean, DisposableBean {
  ...
  private static final CosmoLogger LOGGER =
      LoggerFactory.getLogger(LogCategory.DISCOVERY_LOG_CATEGORY, "DiscoveryClientServiceImpl");
  ...
  public void afterPropertiesSet() throws Exception {
    LOGGER.info("afterPropertiesSet", "initializing discovery client service");
  ...
  public void destroy() throws Exception {
    LOGGER.info("destroy", "destroying discovery client service");
    if (this.client != null) {
      this.client.close();
    }
  }
