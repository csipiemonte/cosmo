...
package it.csi.test.cosmo.cosmobe.testbed.model;
...
import it.csi.cosmo.cosmobe.business.service.impl.ClientServiceImpl;
import it.csi.cosmo.cosmobe.security.SecurityInterceptor;
import it.csi.test.cosmo.cosmobe.testbed.config.TestConstants;
...
public abstract class ParentIntegrationTest extends ParentUnitTest {
  ...
  protected void autentica(UserInfoDTO userInfo) {
    ...
    request.setAttribute(ClientServiceImpl.CLIENTINFO_REQUESTATTR, userInfo);
